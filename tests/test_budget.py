...
from plugah.budget import CFO, BudgetAlert, BudgetManager, CostEstimator
from plugah.oag_schema import BudgetCaps, BudgetModel, BudgetPolicy, RoleLevel
...
def test_cfo_spend_approval():
    ...
    assert result_low["approved"] is False
